...
//------------------------------------------------------------------
	...
	public int saveE(Evento ev) {
		return jdbcTemplate.update("INSERT INTO evento(Categoria, nome-evento, valutazione, luogo) VALUE(?,?,?,?)", new Object[] {ev.getCategoria(), ev.getNome_evento(),ev.getValutazione(), ev.getLuogo()});
